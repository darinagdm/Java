...
/**
 * Клас контролера головного екрану
 *
...
public class MainController {
    ...
    public void onOpen() throws IOException {
        ...
        //  Встановлюємо високі параметри якості зображення
    ...
    private void updateImage() {
        ...
        for (Item item : listViewItems.getItems()) {
            ...
            // Переводимо значення слайдера у відповідний здвиг по вісі x
            ...
            // Переводимо значення слайдера у відповідний здвиг по вісі y
    ...
    /**
     * Конвертуємо об'єкт кольору JavaFX в об'єкт кольору Swing/Awt
     */
